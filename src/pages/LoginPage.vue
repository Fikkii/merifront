<template>
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8">
      <div class="w-full max-w-md space-y-6">
        ...
        <div class="flex items-center space-x-4">
          <img src="https://via.placeholder.com/40x40?text=3MTT" alt="3MTT logo" class="w-10 h-10" />
          <img src="https://via.placeholder.com/40x40?text=NG" alt="Nigeria logo" class="w-10 h-10" />
        </div>

        <!-- Heading -->
        <div>
          <h2 class="text-2xl font-bold text-gray-900">Welcome back</h2>
          <p class="text-gray-500">Kindly provide your personal details below</p>
        </div>
  ...
  <path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd"/>
        ...
        <p class="text-center text-xs text-gray-400">Powered by <span class="text-blue-500 font-bold">fikki.com.ng</span></p>
      </div>
    </div>

  ...
  <div class="flex h-screen bg-white">
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8">
      <div class="w-full max-w-md space-y-6">
        <!-- Login Form -->
        <form @submit.prevent="handleLogin" class="space-y-4 border-[3px] border-blue-500 p-6 rounded-lg shadow-2xl relative">
            <h2 class="text-2xl underline">Login to Continue</h2>
          <div>
          ...
          <RouterLink class="block text-center bg-orange-500 text-white rounded shadow opacity-70 p-2 hover:opacity-90" :to="{ name: 'signup' }">Signup</RouterLink>
        </form>
